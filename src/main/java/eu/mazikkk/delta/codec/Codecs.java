...
import eu.mazikkk.delta.util.function.PentaFunction;
import eu.mazikkk.delta.util.function.QuadFunction;
import eu.mazikkk.delta.util.function.TriFunction;
